...
void loop() {
 ...
 // Dit deel van de code vertelt de LEDS wanneer ze aan moeten gaan en wanneer ze weer uitgaan. 3500 delay betekend 3.5 sec voordat de volgende LED aangaat
void ledtimer() {
  digitalWrite (7, HIGH);
  delay(3500);
  for (int i = 6; i >= 2; i--) {
